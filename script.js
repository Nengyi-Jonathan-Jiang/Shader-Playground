...
{let _resizer_mouse_down = false;resizer.addEventListener("mousedown",_=>_resizer_mouse_down = true);window.addEventListener("mousemove",e=>{if(_resizer_mouse_down)resizer.parentElement.style.setProperty("--left-width", e.clientX/window.innerWidth)});window.addEventListener("mouseup",_=>_resizer_mouse_down = false)}
